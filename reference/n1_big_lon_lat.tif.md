...
`n1_big`. This map can be used as a simulation starting point to
...
[`SpatRaster`](https://rspatial.github.io/terra/reference/SpatRaster-class.html)
object with 74 rows and 125 columns containing integer values 0-50 and
...
#> [1] "/github/home/R/x86_64-pc-linux-gnu-library/4.6/rangr/input_maps/n1_big_lon_lat.tif"
```
