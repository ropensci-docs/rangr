...
object representing a carrying capacity map projected to WGS 84 (CRS84)
from the original raster `K_big`. This map can be used as a carrying
capacity map to
...
is compatible with the `n1_big_lon_lat.tif` raster.

## Format

[`SpatRaster`](https://rspatial.github.io/terra/reference/SpatRaster-class.html)
object with 74 rows and 125 columns containing integer values 0-25 and
...
#> [1] "/github/home/R/x86_64-pc-linux-gnu-library/4.6/rangr/input_maps/K_big_lon_lat.tif"
```
