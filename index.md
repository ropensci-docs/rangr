...
![](reference/figures/README-vis_input_maps-1.png)

## Initialise

To create a `sim_data` object containing the necessary information to
run a simulation, use the
...
which takes a `sim_data` object and the specified number of time steps
...
![](reference/figures/README-summary_sim_res-1.png)
...
that can be set for
[`initialise()`](https://docs.ropensci.org/rangr/reference/initialise.md)
and [`sim()`](https://docs.ropensci.org/rangr/reference/sim.md). See the
documentation for the `rangr` package for more information.
...
is used to generate the plot. Here’s an example:
...
![](reference/figures/README-vis_sim_res_01-1.png)
...
![](reference/figures/README-vis_sim_res_02-1.png)
...
![](reference/figures/README-vis_sim_res_04-1.png)
